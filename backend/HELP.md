...
* [Spring Security](https://docs.spring.io/spring-boot/docs/3.2.0-SNAPSHOT/reference/htmlsinge/index.html#web.security)
* [Spring LDAP](https://docs.spring.io/spring-boot/docs/3.2.0-SNAPSHOT/reference/htmlsinge/index.html#data.nosql.ldap)
